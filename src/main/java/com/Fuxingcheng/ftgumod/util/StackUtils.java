package com.Fuxingcheng.ftgumod.util;
...
import com.Fuxingcheng.ftgumod.api.util.predicate.ItemCompound;
import com.Fuxingcheng.ftgumod.api.util.predicate.ItemIngredient;
...
public class StackUtils implements IStackUtils {
	...
	static {
		...
		ORE_DICT_TO_TAG.put("oreIron", "forge:ores/iron");
		ORE_DICT_TO_TAG.put("oreGold", "forge:ores/gold");
		ORE_DICT_TO_TAG.put("dustRedstone", "c:dusts/redstone");
		ORE_DICT_TO_TAG.put("paper", "ftgumod:paper");
		ORE_DICT_TO_TAG.put("leather", "c:leathers");
		ORE_DICT_TO_TAG.put("feather", "forge:feathers");
