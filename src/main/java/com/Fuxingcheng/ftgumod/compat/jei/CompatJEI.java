...
import com.Fuxingcheng.ftgumod.api.technology.recipe.IIdeaRecipe;
import com.Fuxingcheng.ftgumod.api.technology.recipe.IResearchRecipe;
import com.Fuxingcheng.ftgumod.api.technology.recipe.IdeaRecipe;
...
public class CompatJEI implements IModPlugin {
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
		...
		if (researchGuideCategory != null) {
			registration.addRecipeCatalysts(researchGuideCategory.getRecipeType(),
					new ItemStack(Content.i_magnifyingGlass.get()));
	...
	public static class ResearchGuideCategory implements IRecipeCategory<ResearchGuideEntry> {
		...
		public ResearchGuideCategory(IGuiHelper guiHelper) {
			this.recipeType = RecipeType.create(FTGU.MODID, "research_guide", ResearchGuideEntry.class);
